...
## 30분 개선: 원금균등의 마지막 달 납입액까지 노출

원금균등은 월 납입액이 계속 줄어드는 구조라서 첫 달 값만 보면 체감이 과장될 수 있습니다. 그래서 비교 문구를 아래처럼 개선했습니다.

- 기존: 원금균등 첫 달 납입액만 표시
- 개선: **원금균등 첫 달 → 마지막 달 납입액** 함께 표시

이 변경으로 사용자는 "초기 부담이 크지만 후반에는 얼마나 내려가는지"를 한눈에 파악할 수 있습니다.
