---
layout: tool
title: Average Calculator | Mean, Median, Sum, Range
description: Paste a number list to calculate average, median, sum, minimum, maximum, and range instantly. Supports commas, spaces, line breaks, decimals, and negative values.
lang: en
...
keywords: [average calculator, mean calculator, median calculator, range calculator, sum calculator, number list stats]
related_tools: [percent-calculator, average-speed-calculator, unit-converter, text-counter]
faq:
  - q: How should I input numbers?
    a: You can separate numbers by commas, spaces, or line breaks.
