...
Use this tool when split JSON files with similar schema need to be combined fast.

Examples: paged API exports, chunked logs, or batch output files.
...
2. Pick merge mode (default: Auto).
3. Click **Merge JSON**.
