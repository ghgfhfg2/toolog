---
layout: tool
title: Split Bill Calculator | Per-Person Amount with Rounding
description: Calculate per-person amount, rounded share, and last-person adjustment from total bill and group size.
category: calculator
