---
layout: tool
title: Unit Price Calculator | Compare Price per Item, 100g, and 1L
description: Use the unit price calculator to compare bundle prices by price per item, per 100g, per 1kg, per 100ml, and per liter.
category: calculator
...
keywords: [unit price calculator, price per item calculator, price per 100g, bundle price comparison, value for money calculator]
