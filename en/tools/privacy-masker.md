...
keywords: [privacy masker, redact phone number, mask email, card number masking, account number masking, Korean resident registration number masking, text anonymizer]
...
### 5) Checking high-risk Korean ID-style candidates
