---
layout: tool
title: Percent Calculator | Percentage, Ratio, and Change Rate
description: Instantly calculate A% of B, what percent A is of B, and increase/decrease rate for reports, pricing, and daily math.
lang: en
...
## What can this percent calculator do?
This tool covers three common cases in one place:
- Calculate **A% of B**
...
- Validation for zero-division and invalid inputs
